...
import frc.robot.commands.swerve_simple.SwerveDriveHeadingCommand;
...
public class RobotContainer
{
  ...
  SwerveSimple swerveSimple = new SwerveSimple();
  ...
  SwerveDriveHeadingCommand driveHeadingCommand = new SwerveDriveHeadingCommand(
    swerveSimple,
    () -> driverXbox.getLeftX(),  // Translation X from left stick
    () -> driverXbox.getLeftY(),  // Translation Y from left stick
    () -> driverXbox.getRightX(), // Heading X from right stick
    () -> driverXbox.getRightY()  // Heading Y from right stick
);

  swerveSimple.setDefaultCommand(driveHeadingCommand);
